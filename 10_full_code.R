...
#Some have taken subjects privately, and so these are moved to STP.
data19$STP[data19$STP == "" & data19$FAGSTATUS == "P"] <- data19$SKR[data19$STP == "" & data19$FAGSTATUS == "P"] #converting exam grades to
data19$STP[data19$STP == "" & data19$FAGSTATUS == "P"] <- data19$MUN[data19$STP == "" & data19$FAGSTATUS == "P"] #STP for privatist courses
...
grid.arrange(biology, Math_n, Math_s, chemistry,physics, ncol = 2)
